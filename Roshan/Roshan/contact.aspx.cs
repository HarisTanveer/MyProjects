...
namespace Roshan
{
    public partial class contact : System.Web.UI.Page
    {
        ...
        protected void Send_Click(object sender, EventArgs e)
        {
            ...
            string b = email.Value.ToString();
            string c = con.Value.ToString();
            string d = message.Value.ToString();
            ...
            try
            {
                ...
                msg.Subject = "A new Contact";
                msg.Body = "Name : " + a + ". Email: " + b + ". Contact : " + c + ". Message : "+d;
                client.Send(msg);
