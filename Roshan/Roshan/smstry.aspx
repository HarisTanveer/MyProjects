<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="smstry.aspx.cs" Inherits="Roshan.smstry" %>
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu dropdown-lg no-padding">
								<li class="dropdown-header"><a href="#" class="dropdown-close">×</a>Today</li>
								...
								<li class="dropdown-header"><a href="#" class="dropdown-close">×</a>Yesterday</li>
								<li class="notification">
									<a href="#">
			...
			<div class="header-search-bar">
                <form action="#" method="POST" name="search_bar_form">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control ui-autocomplete-input" id="header-search" placeholder="Search infinite admin..." autocomplete="off">
